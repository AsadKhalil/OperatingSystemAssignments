...
uint DirectoryTree::AddFile(const string& file) {
...
bool DirectoryTree::ChangeDirectory(const string& directory) {
...
vector<string> DirectoryTree::ListDirectories() {
...
bool DirectoryTree::AddDirectory(const string& directory) {
...
void DirectoryTree::RemoveFile(const string& file) {
...
bool DirectoryTree::RemoveDirectory(const string& directory) {

	stack<json> jsonStack;
...
string DirectoryTree::GetCurrentDirectory() { 
...
void DirectoryTree::Flush() {
	...
	ofstream fout("VCB/DT.json");

	if (!fout) {

		cout << "VCB Directory Doesn not Exists!" << endl;
		return;
	}
